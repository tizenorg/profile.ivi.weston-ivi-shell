...
%build
%autogen --disable-static  --enable-simple-clients --enable-clients  --disable-libunwind --disable-xwayland --disable-xwayland-test --disable-x11-compositor --disable-rpi-compositor --disable-weston-launch --disable-clients --disable-wcap-tools
make %{?_smp_mflags}
